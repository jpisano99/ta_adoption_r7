...
push_list_to_csv(my_new_list, 'services_csv.csv')
load_infile('services', 'services_csv.csv')
...
push_list_to_csv(my_new_list, 'subscriptions_csv.csv')
load_infile('subscriptions', 'subscriptions_csv.csv')
...
push_list_to_csv(my_new_list, 'bookings_csv.csv')
load_infile('bookings', 'bookings_csv.csv')
